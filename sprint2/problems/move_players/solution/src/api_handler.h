...
namespace http_handler {
    ...
    public:
        ...
        void operator()(http::request<Body, http::basic_fields<Allocator>>&& req, Send&& send) {
            ...
            // Проверяем, что путь начинается с /api/v1/
            ...
            // Обработка существующих эндпоинтов
    ...
    private:
        ...
        // --- Обработчик /api/v1/game/players ---
        template <typename Body, typename Allocator, typename Send>
        ...
        // --- Обработчик /api/v1/game/player/action ---
        template <typename Body, typename Allocator, typename Send>
        ...
        // --- Шаблонная функция для авторизации ---
