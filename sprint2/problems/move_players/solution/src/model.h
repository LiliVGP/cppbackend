...
namespace model {
    ...
    // Position, Velocity, Direction определены в player.h
    ...
    private:
        ...
        std::optional<double> dogSpeed_; // <-- НОВОЕ ПОЛЕ
    };
    ...
    private:
        ...
        double defaultDogSpeed_ = 1.0; // <-- НОВОЕ ПОЛЕ
    };
