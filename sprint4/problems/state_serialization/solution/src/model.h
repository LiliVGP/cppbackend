...
namespace model {
    ...
    public:
        ...
        void AddLostItem(LostItem item) {
            lost_items_.push_back(std::move(item));
        }

        const std::vector<LostItem>& GetLostItems() const noexcept {
            return lost_items_;
        }

        std::vector<LostItem>& GetLostItems() noexcept {
            return lost_items_;
        }
    ...
    private:
        ...
        std::vector<LostItem> lost_items_;
    };
